        ...
        return $table
                ...
                Filter::make('created_at')
                    ...
                    ->indicateUsing(function (array $data): array {
                        ...
                        if ($data['created_until'] ?? null) {
                            $indicators['created_until'] = 'Created until ' . Carbon::parse($data['created_from']);
                        }
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ...
                    ->modalDescription('Are you sure you\'d like to delete this employee? This cannot be undone.')
        ...
        return $infolist
            ->schema([
                Section::make('Locations')
                    ->description('Show information of employee')
                    ->schema([
                ...
                Section::make('Address')
                    ->description('Show address of employee')
                    ->schema([
